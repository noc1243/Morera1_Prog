object Form1: TForm1
  ...
  object Memo1: TMemo
    ...
    Lines.Strings = (
      ...
      ' '
        ...
        'O programa realiza análises no estado permanente senoidal de cir' +
        'cuitos não lineares'

        'invariantes no tempo, usando um modelo linearizado em torno do p' +
        'onto de operação,'
      'calculando respostas em frequência.'
      '')
    ParentFont = False
    ScrollBars = ssBoth
    TabOrder = 0
  ...
  object MainMenu1: TMainMenu
    ...
    object Opes1: TMenuItem
      ...
      object MostrarOperacoes: TMenuItem
        AutoCheck = True
        Caption = 'Nao mostrar operacoes'
        Checked = False
      end
    end
  end
